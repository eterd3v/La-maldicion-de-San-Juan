...
undum.game.situations = {
    ...
    salir_casa: new undum.SimpleSituation(
        ...
        "<em><a href='fin'>¿Miro en el bolsillos de los pantalones?</a></em></br>" +
        "<em><a href='fin'>¿Miro en el cerrojo de la puerta?</a></em><br>" +
        "<em><a href='fin'>¿Y si salgo sin llaves?</a></em><br>" +
        "</p>"
        ,
    ),
