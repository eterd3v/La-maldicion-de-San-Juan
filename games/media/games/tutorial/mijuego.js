...
undum.game.situations = {
    start: new undum.SimpleSituation(
        "<p class='transient'>Click <a href='hub'>this link to continue...</a></p>"
    ),
    ...
    "quality-types": new undum.SimpleSituation(
        ...
        get to choose how to display hemselves. So 'Luck', for example, is\
...
undum.game.qualities = {
    moneda_antigua: new undum.OnOffQuality(
        ...
        {priority:"0010", group:'estadisticas'},
    ),
...
undum.game.qualityGroups = {
    ...
    //objeto: new undum.QualityGroup()
    progress: new undum.QualityGroup('Objetos', {priority:"0002"})
};
